                        ...
                        <div class>
                          <div id="post-423" class="post-423 page type-page status-publish hentry">
                            ...
                            <div class="entry-content-cp">
                                  ...
                                  <div class="vc_column-inner ">
                                    <div class="wpb_wrapper">
                                      ...
                                      <div class="schedule-box"> <strong class="title">Phones</strong>
                                        <p>+2348059133844, +2347087395119</p>
                                        <p>hispraisemin@yahoo.co.uk</p>
                                        <p>G.P.O Box 11518</p>
                                      </div>
                                      <div class="schedule-box pull-right"> <strong class="title">Location</strong>
                                        <p>Martola Street, Off Winners Way Bashorun/Ashi Exit, Ibadan, Oyo State, Nigeria.</p>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                    ...
                                    <div class="wpb_wrapper">
                                      ...
                                      <div class="wpb_text_column wpb_content_element ">
                                        <div class="wpb_wrapper">
                                          ...
                                          <p>•	To gain and equip the Youth to consistently align with the will and expectations of Jesus Christ unto eternity.</p>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="wpb_column vc_column_container vc_col-sm-4" id="vision">
                                  <div class="vc_column-inner ">
                                    <div class="wpb_wrapper">
                                      <div class="container">
                                        <div class="heading-left">
                                      ...
                                      <div class="wpb_text_column wpb_content_element ">
                                        <div class="wpb_wrapper">
                                          ...
                                          <p>•	Ensuring a vibrant and Godly Youth crowd in place to take over the baton of the Gospel with an unbroken succession</p>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                        ...
                                        <div class="wpb_wrapper" style="text-align: center;">
                                          <p>
                                            <ul class="vc_col-sm-6">
                                              <li>Sanctity</li><li>Fidelity</li><li>Love</li>
                                            </ul>
                                            <ul class="vc_col-sm-6">
                                              <li>Discipline</li><li>Obedience</li><li>Humility</li>
                                            </ul>
                                          </p>
                                        </div>
                                      </div>
                              ...
                              <div class="wpb_column vc_column_container vc_col-sm-12">
                                <div class="vc_column-inner ">
                                  <div class="wpb_wrapper">
                                    <div class="container">
                                      <div class="heading-left">
                                        <span>Reasons for Existence</span>
                                      </div>
                                    </div>
                                    <div class="wpb_text_column wpb_content_element ">
                                      <div class="wpb_wrapper">
                                    ...
                                    <div class="wpb_text_column wpb_content_element ">
                                      <div class="wpb_wrapper">
                                        <p>We strongly believe in the biblical concepts of morality, fidelity, peaceful co-existence, parental leadership and unity of the spirit. It is only, we believe, through a return to these godly beneficial concepts that we can arrest the continual erosion of the family unit and mutual understanding in the church society.</p>
                                      </div>
                                    </div>
                                    <div class="container">
                                      <div class="heading-left">
                                    ...
                                    <div class="wpb_text_column wpb_content_element ">
                                      <div class="wpb_wrapper">
                                        <p>Primarily, at His Praise Ministries, we are accountable to God Almighty and Jesus Christ, the Head of the Church, in our work of the ministry. Additionally, as a ministry dealing with human beings, we have in place a Board of Trustees and an Advisory Board to report to from time to time concerning the progress and running of the work.</p>
                                      </div>
                                    </div>
                                    <div class="container">
                                      <div class="heading-left">
                              ...
                              <!--<div data-vc-full-width="true" data-vc-full-width-init="false" data-vc-stretch-content="true" class="vc_row wpb_row vc_row-fluid recentprojects vc_custom_1489046706579 vc_row-has-fill vc_row-no-padding">
                                <div class="wpb_column vc_column_container vc_col-sm-12">
                                  <div class="vc_column-inner ">
                                    <div class="wpb_wrapper">
                                      <div class="container">
                                        <div class="heading-left">
                                          ...
                                          <span>Here are our pROJECTS </span>
                                        </div>
                                      </div>
                                        ...
                                        <div class="container">
                                          <div class="row">
                                            <div class="col-md-4 col-sm-4">
                                              <div class="box"> <img src="../hpm-content/uploads/2017/03/recent-project-img-1.jpg" alt="img">
                                                <div class="caption"> <a href="#" class="btn-play" data-toggle="modal" data-target="#myModal446"><span class="icon-play-button"></span></a>

                                                  <div class="modal fade" id="myModal446" tabindex="-1" role="dialog">
                                                    <div class="modal-dialog" role="document">
                                                      <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                          <iframe src="https://player.vimeo.com/video/131302295?color=ffffff&amp;title=0&amp;portrait=0" style="width:100%; height:557px; border:0;"></iframe>
                                                        </div>
                                                      </div>
                                                    </div>
                                                  </div>
                                            ...
                                            <div class="col-md-4 col-sm-4">
                                              <div class="box"> <img src="../hpm-content/uploads/2017/03/recent-project-img-2.jpg" alt="img">
                                                <div class="caption"> <a href="#" class="btn-play" data-toggle="modal" data-target="#myModal447"><span class="icon-play-button"></span></a>

                                                  <div class="modal fade" id="myModal447" tabindex="-1" role="dialog">
                                                    <div class="modal-dialog" role="document">
                                                      <div class="modal-content">
                                                        <div class="modal-header">
                                                          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span></button>
                              ...
                              <div class="vc_row-full-width vc_clearfix"></div>-->
                              <div data-vc-full-width="true" data-vc-full-width-init="false" class="vc_row wpb_row vc_row-fluid vc_custom_1489064211422 vc_row-has-fill">
                                <!--<div class="wpb_column vc_column_container vc_col-sm-6">
                                  <div class="vc_column-inner ">
                                    <div class="wpb_wrapper">
                                      <div class="container">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                              <div class="sermon-box">
                                                <div class="round-frame">
                                                  <img src="../hpm-content/uploads/2017/03/sermon-img-1-88x88.jpg" alt="img">
                                                </div>
                                                <div class="holder">
                                    ...
                                    <div class="wpb_wrapper">
                                      ...
                                      <div class="store-box">
                                        <div class="store-banner owl-carousel owl-theme">
                                          ...
                                          <div class="item">
                                            <div class="left-box">
                                              <strong class="title">Deacon Paul O. Ajayi</strong>
                                              <span>SECRETARY</span>
                                            </div>
                                          ...
                                          <div class="item">
                                            <div class="left-box">
                                              <strong class="title">MR. OLAWUYI OLADIMEJI A.</strong>
                                            </div>
                                            <div class="thumb"><img src="../board/profile-pic/olawuyi-oladimeji.jpg" alt="OLAWUYI OLADIMEJI"></div>
                                            <div class="text-box">
                                              <p>A House-fellowship minister who is also actively involved in the youth ministry of his home Church, “Dimeji” Olawuyi is a man of many parts.  He is a business man who co founded and runs 3 different companies – Dimlaw Net Services, Smartminds Professional Services and AIRDEF which are into Water Engineering, ICT and Agric sectors respectively.</p>
                                            </div>
                                          </div>
                                          <div class="item">
                                            <div class="left-box">
                                              <strong class="title">MRS. OLAWUYI YETUNDE O.</strong>
                                            </div>
                                            <div class="thumb"><img src="../board/profile-pic/olawuyi-yetunde.jpg" alt="OLAWUYI YETUNDE"></div>
                                            <div class="text-box">
                                          ...
                                          <div class="item">
                                            <div class="left-box">
                                              <strong class="title">BARRISTER OYEBOLA ILORI AYOADE</strong>
                                            </div>
                                            <div class="thumb"><img src="../board/profile-pic/ilori-ayoade.jpg" alt="ILORI AYOADE"></div>
                                            <div class="text-box">
                                          ...
                                          <div class="item">
                                            <div class="left-box">
                                              <strong class="title">PASTOR FEMI ADEKUNLE</strong>
                                            </div>
                                            <div class="thumb"><img src="../board/profile-pic/femi-adekunle.jpg" alt="FEMI ADEKUNLE"></div>
                                            <div class="text-box">
                                          ...
                                          <div class="item">
                                            <div class="left-box">
                                              <strong class="title">MRS OLABISI ADEKUNLE</strong>
                                            </div>
                                            <div class="thumb"><img src="../board/profile-pic/olabisi-adekunle.jpg" alt="OLABISI ADEKUNLE"></div>
                                            <div class="text-box">
                                          ...
                                          <div class="item">
                                            <div class="left-box">
                                              <strong class="title">Mr Oladapo Adetula</strong>
                                            </div>
                                            <div class="thumb"><img src="../board/profile-pic/oladapo-adetula.jpg" alt="Oladapo Adetula"></div>
                                            <div class="text-box">
                                              <p>Mr Oladapo Adetula was born on August 14th 1955 in Ondo State. A product of Christs School,Ado-Ekiti and holds a bachelors and a Masters degree in Pharmacy from University of Ife,Ile- Ife. Presently practices as a registered pharmacist in Florida, US.</p>
                                            </div>
                                          </div>
                                          <div class="item">
                                            <div class="left-box">
                                              <strong class="title">Bolajoko T. Adesina</strong>
                                            </div>
                                            <div class="thumb"><img src="../board/profile-pic/bolajoko-adesina.jpg" alt="Bolajoko T. Adesina"></div>
                                            <div class="text-box">
                                              <p>Bolajoko (Bola) Adesina, born on June 26, 1961, is a high school teacher with over 30 years experience. She is a qualified English and Special Education teacher with two separate Master's degrees in these areas from the University of New South Wales, Sydney and the University of Sydney, Australia.</p>
                                            </div>
                                          </div>
                                          <div class="item">
                                            <div class="left-box">
                                              <strong class="title">Adesoji A. Adesina</strong>
                                            </div>
                                            <div class="thumb"><img src="../board/profile-pic/adesoji-adesina.jpg" alt="Adesoji A. Adesina"></div>
                                            <div class="text-box">
